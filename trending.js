...
function test(){
    $.ajax('https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=26.9124, 75.7873&radius=25000&type=restaurant&key=AIzaSyBPNmNUeZ6oAm0EWYt6jey70TzrZRrrDdo', {
    success: function(result) {
        console.log("Hello");
    },
    error: function() {
        localStorage.backtrack = 'home.html';
