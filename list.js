...
function first_ajax() {
    ...
    return $.ajax({
    	//location=26.9124, 75.7873&radius=25000
    url: 'https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=28.635704,77.224982&radius=25000&type=restaurant&key=' + key,
        method: 'GET',
        dataType: 'json',
        success: function(data) {
            var temp_name, temp_add, temp_rating, temp_id, temp_type, temp_image;
            var i;
            token = data.next_page_tok
