...
if (localStorage.all_movie_list) {
	...
	// return $.ajax({
  //                           url:'https://api.themoviedb.org/3/discover/movie?api_key=fc3c055dbae6de898caa4bae948ed685&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=true&page=1&primary_release_year=2016&primary_release_date.gte=2016-9-10&primary_release_date.lte=2016-10-10',
  //                           method: 'GET',
  //                           dataType: 'json',
...
// 	return $.ajax({
//                             url:'https://api.themoviedb.org/3/discover/movie?api_key=fc3c055dbae6de898caa4bae948ed685&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=true&page=2&primary_release_year=2016&primary_release_date.gte=2016-9-10&primary_release_date.lte=2016-10-10',
//                             method: 'GET',
//                             dataType: 'json',
//                             success:function(data){
//                                     var result=[];
...
// 	return $.ajax({
//                             url:'https://api.themoviedb.org/3/discover/movie?api_key=fc3c055dbae6de898caa4bae948ed685&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=true&page=3&primary_release_year=2016&primary_release_date.gte=2016-9-10&primary_release_date.lte=2016-10-10',
//                             method: 'GET',
//                             dataType: 'json',
//                             success:function(data){
//                                     var result=[];
